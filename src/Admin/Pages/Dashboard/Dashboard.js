			...
			<nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
				<div className="px-3 py-3 lg:px-5 lg:pl-3">
					<div className="flex items-center justify-between">
						...
						<Link to={'new-post'} className=" ml-auto mr-10 flex items-center gap-1 text-primary-600">
							<CiEdit size={21} />
							Write
						</Link>
						<div className="flex items-center">
							<div className="flex items-center ml-3 relative">
								...
								<div className="z-50 hidden absolute my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
